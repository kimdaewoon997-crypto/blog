...
<article class="post-body">
  ...
  <div style="margin:30px 0;text-align:center;">
    ...
    <p style="font-size:13px;color:var(--muted);text-align:center;margin-top:10px;">▲ 판매 형태에 따른 두 업종의 법적 비교</p>
  </div>
  ...
  <div style="margin:36px 0;background:#f8fafc;padding:18px;border-radius:8px;border:1px solid var(--border);">
    ...
    <p style="font-size:13px;color:var(--navy);font-weight:700;text-align:center;margin-top:12px;margin-bottom:4px;">▲ 대행을 통해 발급 완료된 정식 식품제조가공업 영업등록증</p>
    <p style="font-size:11px;color:var(--muted);text-align:center;margin:0;">(실제 성남시 중원구 식품제조가공업 현장 실사 후 교부된 영업등록증입니다.)</p>
  </div>
