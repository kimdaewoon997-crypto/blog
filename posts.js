...
<article class="post-body">
  ...
  <ul>
    <li><strong>식품제조·가공업:</strong> 식품을 다른 식당, 프랜차이즈 가맹점, 마트, 도매업소 등 <em>판매를 목적으로 하는 다른 영업자에게 납품 및 유통(B2B)</em>할 수 있으며, 온라인 등으로 최종 소비자에게 직접 판매(B2C)하는 것도 모두 허용됩니다.</li>
    <li><strong>즉석판매제조·가공업:</strong> 내 영업장 안에서 또는 온라인으로 '최종 소비자'에게 직접 판매하거나, 개인 고객의 주문을 받아 우편·택배로 배달(B2C)하는 것만 가능합니다. <strong>내가 만든 식품을 다른 식당이나 마트 등 다른 영업자에게 납품(B2B)하는 행위는 원칙적으로 금지</strong>됩니다. 다만, 과자·빵·떡류에 한해서만 당일 제조하여 당일 판매하는 조건으로 일부 유통이 예외적으로 허용됩니다.</li>
  </ul>
